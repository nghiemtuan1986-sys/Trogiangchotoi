...
<div class="main-header">
    ...
    <p>Tác giả: Nghiêm Thanh Tuấn - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0365 601 999</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nghiêm Thanh Tuấn - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0365 601 999</div>", unsafe_allow_html=True)
